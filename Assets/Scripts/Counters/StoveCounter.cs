...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    [SerializeField] private FryingRecipeSO[] fryingRecipeSOArray; [SerializeField] private BurningRecipeSO[] burningRecipeSOArray;
    ...
    private void FryingTimer_OnValueChanged(float previousValus, float newValue)
    {
    ...
    private void BurningTimer_OnValueChanged(float previousValus, float newValue)
    {
    ...
    private void State_OnValueChanged(State previousValus, State newValue)
    {
